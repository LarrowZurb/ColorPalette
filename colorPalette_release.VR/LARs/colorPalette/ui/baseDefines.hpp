...
class RscDisplayDLCContentBrowser_RscTextMultiline: RscText
{
	style = ST_MULTI + ST_NO_RECT;
};
class RscDisplayDLCContentBrowser_ListGroup: RscControlsGroupNoHScrollbars
{
	idc = 38400;
	x = 1.2 * GUI_GRID_W + (safezoneX + (safezoneW - GUI_GRID_WAbs)/2);
	y = 8.9 * GUI_GRID_H + (safezoneY + (safezoneH - GUI_GRID_HAbs)/2);
	w = 37.8 * GUI_GRID_W;
	h = 14 * GUI_GRID_H;
	class controls
